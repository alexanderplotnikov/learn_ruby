...
describe "power" do
  ...
  it "raises one number to the Negative power of another number" do
    expect(power(4, -2)).to eq(0.0625)
  end
end
...
describe "factorial" do
  ...
  it "returns an ERROR for the factorial of -7" do
    expect(factorial(-7)).to eq('ERROR')
  end
end
